...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'powerpc64le-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/config/workspace/env/lib '
 ...
 'CONFIGURE_CFLAGS': '-mcpu=power8 -mtune=power8 -mpower8-fusion '
                     ...
                     '-fdebug-prefix-map=/config/workspace/env=/usr/local/src/conda-prefix '
                     '-pipe    '
                     ' ',
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/config/workspace/env/lib '
                      '-L/config/workspace/env/lib',
 'CONFIG_ARGS': "'--prefix=/config/workspace/env' "
                ...
                "-I/config/workspace/env/include' "
                "'CPP=/config/workspace/env/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/config/workspace/env/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/config/workspace/env/lib/pkgconfig',
 'LIBPL': '/config/workspace/env/lib/python3.8/config-3.8-powerpc64le-linux-gnu',
